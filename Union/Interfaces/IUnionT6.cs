...
namespace Union
{
    public interface IUnion<T0, T1, T2, T3, T4, T5, T6> : IUnion
        where T0 : notnull
        where T1 : notnull
        where T2 : notnull
        where T3 : notnull
        ...
        where T6 : notnull
    {
        ...
        public Union<TResult, T1, T2, T3, T4, T5, T6> Select0<TResult>(Func<T0, TResult> selector) where TResult : notnull;
        public Union<T0, TResult, T2, T3, T4, T5, T6> Select1<TResult>(Func<T1, TResult> selector) where TResult : notnull;
        public Union<T0, T1, TResult, T3, T4, T5, T6> Select2<TResult>(Func<T2, TResult> selector) where TResult : notnull;
        public Union<T0, T1, T2, TResult, T4, T5, T6> Select3<TResult>(Func<T3, TResult> selector) where TResult : notnull;
        public Union<T0, T1, T2, T3, TResult, T5, T6> Select4<TResult>(Func<T4, TResult> selector) where TResult : notnull;
