...
namespace Union
{
    public class UnionClass<T0, T1, T2, T3, T4, T5, T6> : IUnion, IEquatable<UnionClass<T0, T1, T2, T3, T4, T5, T6>>
        where T0 : notnull
        where T1 : notnull
        where T2 : notnull
        where T3 : notnull
        ...
        where T6 : notnull
    {
        private UnionClass(UnionIndexT6 index, T0? value0 = default, T1? value1 = default, T2? value2 = default, T3? value3 = default, T4? value4 = default, T5? value5 = default, T6? value6 = default)
        {
            this.Index = index;
            this.value0 = default;
            this.value1 = default;
        ...
        public UnionClass(T0 value) : this(UnionIndexT6.T0, value0: value) { }
        public UnionClass(T1 value) : this(UnionIndexT6.T1, value1: value) { }
        public UnionClass(T2 value) : this(UnionIndexT6.T2, value2: value) { }
        public UnionClass(T3 value) : this(UnionIndexT6.T3, value3: value) { }
        public UnionClass(T4 value) : this(UnionIndexT6.T4, value4: value) { }
        public UnionClass(T5 value) : this(UnionIndexT6.T5, value5: value) { }
        public UnionClass(T6 value) : this(UnionIndexT6.T6, value6: value) { }
        ...
        #region From Methods
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT0(T0 t) => new (UnionIndexT6.T0, value0: t);
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT1(T1 t) => new (UnionIndexT6.T1, value1: t);
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT2(T2 t) => new (UnionIndexT6.T2, value2: t);
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT3(T3 t) => new (UnionIndexT6.T3, value3: t);
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT4(T4 t) => new (UnionIndexT6.T4, value4: t);
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT5(T5 t) => new (UnionIndexT6.T5, value5: t);
        public static UnionClass<T0, T1, T2, T3, T4, T5, T6> FromT6(T6 t) => new (UnionIndexT6.T6, value6: t);
        #endregion From Methods

        #region Conversions
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T0 t) => FromT0(t);
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T1 t) => FromT1(t);
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T2 t) => FromT2(t);
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T3 t) => FromT3(t);
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T4 t) => FromT4(t);
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T5 t) => FromT5(t);
        public static implicit operator UnionClass<T0, T1, T2, T3, T4, T5, T6>(T6 t) => FromT6(t);
        ...
        public bool Equals(UnionClass<T0, T1, T2, T3, T4, T5, T6>? other) => this.Index switch
        {
        ...
        public override bool Equals(object? obj) => obj is UnionClass<T0, T1, T2, T3, T4, T5, T6> other && Equals(other);
        public static bool operator ==(UnionClass<T0, T1, T2, T3, T4, T5, T6> left, UnionClass<T0, T1, T2, T3, T4, T5, T6> right) => left.Equals(right);
        public static bool operator !=(UnionClass<T0, T1, T2, T3, T4, T5, T6> left, UnionClass<T0, T1, T2, T3, T4, T5, T6> right) => !left.Equals(right);
        #endregion Equality
    }
}
