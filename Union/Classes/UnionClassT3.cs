...
namespace Union
{
    public class UnionClass<T0, T1, T2, T3> : IUnion, IEquatable<UnionClass<T0, T1, T2, T3>>
        where T0 : notnull
        where T1 : notnull
        where T2 : notnull
        where T3 : notnull
    {
        private UnionClass(UnionIndexT3 index, T0? value0 = default, T1? value1 = default, T2? value2 = default, T3? value3 = default)
        {
            this.Index = index;
            this.value0 = default;
            this.value1 = default;
        ...
        public UnionClass(T0 value) : this(UnionIndexT3.T0, value0: value) { }
        public UnionClass(T1 value) : this(UnionIndexT3.T1, value1: value) { }
        public UnionClass(T2 value) : this(UnionIndexT3.T2, value2: value) { }
        public UnionClass(T3 value) : this(UnionIndexT3.T3, value3: value) { }
        ...
        #region From Methods
        public static UnionClass<T0, T1, T2, T3> FromT0(T0 t) => new (UnionIndexT3.T0, value0: t);
        public static UnionClass<T0, T1, T2, T3> FromT1(T1 t) => new (UnionIndexT3.T1, value1: t);
        public static UnionClass<T0, T1, T2, T3> FromT2(T2 t) => new (UnionIndexT3.T2, value2: t);
        public static UnionClass<T0, T1, T2, T3> FromT3(T3 t) => new (UnionIndexT3.T3, value3: t);
        #endregion From Methods

        #region Conversions
        public static implicit operator UnionClass<T0, T1, T2, T3>(T0 t) => FromT0(t);
        public static implicit operator UnionClass<T0, T1, T2, T3>(T1 t) => FromT1(t);
        public static implicit operator UnionClass<T0, T1, T2, T3>(T2 t) => FromT2(t);
        public static implicit operator UnionClass<T0, T1, T2, T3>(T3 t) => FromT3(t);
        ...
        public bool Equals(UnionClass<T0, T1, T2, T3>? other) => this.Index switch
        {
        ...
        public override bool Equals(object? obj) => obj is UnionClass<T0, T1, T2, T3> other && Equals(other);
        public static bool operator ==(UnionClass<T0, T1, T2, T3> left, UnionClass<T0, T1, T2, T3> right) => left.Equals(right);
        public static bool operator !=(UnionClass<T0, T1, T2, T3> left, UnionClass<T0, T1, T2, T3> right) => !left.Equals(right);
        #endregion Equality
    }
}
