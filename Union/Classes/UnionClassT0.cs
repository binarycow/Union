...
namespace Union
{
    public class UnionClass<T0> : IUnion, IEquatable<UnionClass<T0>>
        where T0 : notnull
    {
        private UnionClass(UnionIndexT0 index, T0? value0 = default)
        {
            this.Index = index;
            this.value0 = default;
            switch (this.Index)
        ...
        public UnionClass(T0 value) : this(UnionIndexT0.T0, value0: value) { }
        ...
        #region From Methods
        public static UnionClass<T0> FromT0(T0 t) => new (UnionIndexT0.T0, value0: t);
        #endregion From Methods

        #region Conversions
        public static implicit operator UnionClass<T0>(T0 t) => FromT0(t);
        ...
        public bool Equals(UnionClass<T0>? other) => this.Index switch
        {
        ...
        public override bool Equals(object? obj) => obj is UnionClass<T0> other && Equals(other);
        public static bool operator ==(UnionClass<T0> left, UnionClass<T0> right) => left.Equals(right);
        public static bool operator !=(UnionClass<T0> left, UnionClass<T0> right) => !left.Equals(right);
        #endregion Equality
    }
}
