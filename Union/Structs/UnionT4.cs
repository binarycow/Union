...
namespace Union
{
    public readonly struct Union<T0, T1, T2, T3, T4> : IUnion, IEquatable<Union<T0, T1, T2, T3, T4>>
        where T0 : notnull
        where T1 : notnull
        where T2 : notnull
        where T3 : notnull
        where T4 : notnull
    {
        ...
        public Union(T0 value) : this(UnionIndexT4.T0, value0: value) { }
        public Union(T1 value) : this(UnionIndexT4.T1, value1: value) { }
        public Union(T2 value) : this(UnionIndexT4.T2, value2: value) { }
        public Union(T3 value) : this(UnionIndexT4.T3, value3: value) { }
        public Union(T4 value) : this(UnionIndexT4.T4, value4: value) { }
        ...
        public bool Equals(Union<T0, T1, T2, T3, T4> other) => this.Index switch
        {
