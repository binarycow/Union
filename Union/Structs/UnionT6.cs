...
namespace Union
{
    public readonly struct Union<T0, T1, T2, T3, T4, T5, T6> : IEquatable<Union<T0, T1, T2, T3, T4, T5, T6>>, IUnion<T0, T1, T2, T3, T4, T5, T6>
    {
        ...
        public T0? AsT0()
        {
            return this.Index == UnionIndexT6.T0 ? value0 : throw new InvalidOperationException($"Cannot return as T0 as result is T{this.Index}");
        }
        public T1? AsT1()
        {
            return this.Index == UnionIndexT6.T1 ? value1 : throw new InvalidOperationException($"Cannot return as T1 as result is T{this.Index}");
        }
        public T2? AsT2()
        {
            return this.Index == UnionIndexT6.T2 ? value2 : throw new InvalidOperationException($"Cannot return as T2 as result is T{this.Index}");
        }
        public T3? AsT3()
        {
            return this.Index == UnionIndexT6.T3 ? value3 : throw new InvalidOperationException($"Cannot return as T3 as result is T{this.Index}");
        }
        public T4? AsT4()
        {
            return this.Index == UnionIndexT6.T4 ? value4 : throw new InvalidOperationException($"Cannot return as T4 as result is T{this.Index}");
        }
        public T5? AsT5()
        {
            return this.Index == UnionIndexT6.T5 ? value5 : throw new InvalidOperationException($"Cannot return as T5 as result is T{this.Index}");
        }
        public T6? AsT6()
        {
            return this.Index == UnionIndexT6.T6 ? value6 : throw new InvalidOperationException($"Cannot return as T6 as result is T{this.Index}");
        }
